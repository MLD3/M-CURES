...
args = parser.parse_args([
    "--data_path=./out_4baseline/", 
    "--input_fname=./data_input/4baseline.p", 
    "--population=./data_input/pop.csv", 
    "--T=240", "--dt=240", 
    "--no_prefilter", "--no_postfilter", "--theta_freq=1",
    "--stats_functions", 'min', 'max', 'mean',
])
args.variables = sorted(pd.read_csv('/data/covid/process_data/FIDDLE_for_Sarah/out_vitals/value_types.csv')['variable_name'])
...
joblib.dump(sdf, 'out_4baseline/sdf.joblib')
