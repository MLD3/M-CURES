...
if __name__ == '__main__':
    ...
    args.variables = sorted(pd.read_csv('metadata/flow/value_types.csv')['variable_name'])
    ...
    df_time_series = joblib.load('sample_output/out_flow/sdf.joblib')
    discretization_bins = json.load(open('metadata/flow/discretization.json', 'r'))
    feature_names = json.load(open('metadata/flow/X_all.feature_names.json', 'r'))
    ...
    sparse.save_npz('sample_output/out_flow/X_all.npz', X_all)
    df_time_series[[]].to_csv('sample_output/out_flow/X_all.IDs.csv')
